                        ...
                        {editingName === message.id ? (
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              className="font-serif text-xl font-normal px-2 py-1 rounded border focus:outline-none focus:ring-2"
                              style={{ borderColor: '#e8ece9', color: '#1a1a1a' }}
                              autoFocus
                            />
                            <button
                          ...
                          >
                            <p className="font-serif font-normal text-xl truncate" style={{ color: '#1a1a1a' }}>
                              {name || (
